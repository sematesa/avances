<?php
	...
	if( $_POST['tipo_discontinuidad'] == 'CE' || $_POST['tipo_discontinuidad'] == 'Q' || $_POST['tipo_discontinuidad'] == 'M' || $_POST['tipo_discontinuidad'] == 'R' || $_POST['tipo_discontinuidad'] == 'D' || $_POST['tipo_discontinuidad'] == 'CI' || $_POST['tipo_discontinuidad'] == 'DI'){
			...
			<div class="body">
				...
				<div class="contact">
					...
					<form method="POST" enctype="multipart/form-data">
						...
						<select id="tipo_discontinuidad" name="tipo_discontinuidad" class="opciones">
