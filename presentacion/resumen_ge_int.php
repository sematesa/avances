	...
	<head>
		...
		<script type="text/javascript">
		    ...
		    $.ajax({
		        'async': false,
		        'global': false,
		        'url': 'extraeIndGeInt.php?id_contrato='+<?php echo $_GET['id_contrato'] ; ?>,
		        'dataType': "json",
		...
		<div id="container">
			...
			<div id="indice" >
				<?php
					...
					$registros = $indicacion->getForResumenTotInt($_GET['id_contrato']) ;
...
$tipos_indicaciones = array(
		...
		<div id="pie_pagina">
			<div id="menu_pie">
						...
						<a href="resumen_ge_ei.php?id_contrato=<?php echo $_GET['id_contrato']; ?>">- Indicaciones Externas</a>
