	...
	<head>
		...
		<script type="text/javascript">
		    ...
		    $.ajax({
		        'async': false,
		        'global': false,
		        'url': 'extraeIndInt.php?id_disciplina='+<?php echo $disciplina->getId() ; ?>,
		        'dataType': "json",
		...
		<div id="container">
			...
			<div id="indice" >
				<?php
					...
					$registros = $indicacion->getForResumenInt($disciplina->getId(), $disciplina->getContrato()) ;
				//	var_dump($registros);
					$gran_total = 0 ;
...
$tipos_indicaciones = array(
		...
		<div id="pie_pagina">
			<div id="menu_pie">
				...
				<?php
					$registros = $indicacion->getForResumenExt($disciplina->getId(), $disciplina->getContrato()) ;
					if(!empty($registros)){
						?>
						<a href="resumen_int_tot.php?id_disciplina=<?php echo $disciplina->getId(); ?>">Totales</a>
						<a href="resumen_ei.php?id_disciplina=<?php echo $disciplina->getId(); ?>">Indicaciones Externas</a>
						<?php
					}
