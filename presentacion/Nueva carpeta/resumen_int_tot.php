	...
	<head>
		...
		<script type="text/javascript">
		    ...
		    $.ajax({
		        'async': false,
		        'global': false,
		        'url': 'extraeIndTot.php?id_disciplina='+<?php echo $disciplina->getId() ; ?>,
		        'dataType': "json",
		...
		<div id="container">
			...
			<div id="indice" >
				<?php
					...
					$registros = $indicacion->getForResumenGen($disciplina->getId(),$disciplina->getContrato()) ;
...
$tipos_indicaciones = array(
		...
		<div id="pie_pagina">
			<div id="menu_pie">
						...
						<a href="resumen_int.php?id_disciplina=<?php echo $disciplina->getId(); ?>">- Indicaciones Internas</a>
