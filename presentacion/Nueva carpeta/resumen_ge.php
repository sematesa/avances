...
-->
	...
	<div id="contenedor_general">
		...
		<div id="lateral_izquierda"><input type="hidden" id="cto" value="<?php echo $_GET['id_contrato']; ?>"></div>
...
-->
        ...
        <script type="text/javascript">
            ...
            if(document.getElementById('cto').value == 1){
             ...
             var charDataHc=[{
                ...
                titulo: "PROGRAMADO FEB-DIC(P,FP)",
                titulo2: "PROG. FEB-DIC",
                color: "#CC3300",
                valor: 266,
                etiqueta:"PROGRAMADO FEB-DIC"
            },{
                titulo: "ATENDIDAS",
                titulo2: "ATENDIDAS",
                color: "#44CC00",
        ...
        else if(document.getElementById('cto').value == 2){
