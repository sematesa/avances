	...
	<head>
		...
		<script type="text/javascript">
		    ...
		    $.ajax({
		        'async': false,
		        'global': false,
		        'url': 'extraeIndRef.php?id_referencia='+<?php echo $_GET['id_referencia'] ; ?>,
		        'dataType': "json",
	...
	<div id="contenedor_general">
		...
		<div id="container">
			...
			<div id="submenu">
				<table id="tabla_submenu">
					<tr>
						...
						<td><a href="referencias.php?id_area=<?php echo $area->getId(); ?>"> < Kilometrajes </a></td>
					</tr>
				</table>
			</div>
			...
			<div id="indice" >
				<?php
					...
					$registros = $indicacion->getForResumenKm($_GET['id_referencia']) ;
		...
		<div id="pie_pagina">
			<div id="menu_pie">
				...
				<a href="indicaciones.php?id_referencia=<?php echo $referencia->getId(); ?>">- Tabla de Indicaciones</a>
